...
const erroMsg = "Oops!, No product found, kindly check the URL";

exports.addProduct = async (req, res) => {
  try {
    let dataToSend = await Product.create(req.body);
    ...
    return helper.controllerResult({
      ...
      res,
      statusCode: 400,
      result: { msg: "Product already exist ", error },
...
exports.getAllProduct = async (req, res) => {
  ...
  exports.getProductByID = async (req, res) => {
    try {
      ...
      const dataToSend = await Product.findById(QuizId);
  ...
  exports.searchProduct = async (req, res) => {
    try {
      ...
      const dataToSend = await Product.find({
        $or: [
  ...
  exports.updateProduct = async (req, res) => {
    try {
      const dataToSend = await Product.findByIdAndUpdate(req.params.id, req.body, {
        new: true,
        runValidators: true,
      });
      if (!dataToSend) {
  ...
  exports.deleteProduct = async (req, res) => {
    try {
      const dataToSend = await Product.findByIdAndDelete(req.params.id);
      if (!dataToSend) {
        return helper.controllerResult({
          req,
          res,
  ...
  exports.deleteBulkProduct = async (req, res) => {
